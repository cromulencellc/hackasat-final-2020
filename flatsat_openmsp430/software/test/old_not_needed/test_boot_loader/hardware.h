...
#define KEY_0_ADDR        (*(volatile unsigned int *) 0x00A0)  // KEY higher 16-bits
#define KEY_1_ADDR        (*(volatile unsigned int *) 0x00A2)  // KEY middle higher 16-bits
#define KEY_2_ADDR        (*(volatile unsigned int *) 0x00A4)  // KEY middle lower 16-bits
#define KEY_3_ADDR        (*(volatile unsigned int *) 0x00A6)  // KEY Lower 16-bits
