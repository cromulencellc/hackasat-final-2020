...
/*   5 */ { "DS",                      0,       10,            HS_AMT_ACT_NOACT },
/*   6 */ { "FM",                      0,       10,            HS_AMT_ACT_NOACT },
/*   7 */ { "HS",                      0,       10,            HS_AMT_ACT_NOACT },
/*   8 */ { "HK",                      0,       10,            HS_AMT_ACT_NOACT },
/*   9 */ { "KIT_SCH",                 0,       10,            HS_AMT_ACT_APP_RESTART },
/*  10 */ { "UART_TO_CI",              0,       10,            HS_AMT_ACT_APP_RESTART },
/*  11 */ { "MD",                      0,       10,            HS_AMT_ACT_NOACT },
/*  12 */ { "MM",                      0,       10,            HS_AMT_ACT_NOACT },
/*  13 */ { "SC",                      0,       10,            HS_AMT_ACT_NOACT },
/*  14 */ { "CS",                      0,       10,            HS_AMT_ACT_NOACT },
/*  15 */ { "CF",                      0,       10,            HS_AMT_ACT_NOACT },
/*  16 */ { "LC",                      0,       10,            HS_AMT_ACT_NOACT },
/*  17 */ { "EYASSAT_IF",              0,       10,            HS_AMT_ACT_APP_RESTART },
