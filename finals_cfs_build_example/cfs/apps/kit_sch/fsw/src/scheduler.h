...
#define SCHEDULER_CFG_SCH_CMD_INFO_EID               (SCHEDULER_BASE_EID + 11)


#define SCHEDULER_LOAD_SCH_CMD_ACTIVITY_ERR_EID      (SCHEDULER_BASE_EID + 12)
#define SCHEDULER_LOAD_SCH_CMD_SLOT_ERR_EID          (SCHEDULER_BASE_EID + 13)

#define SCHEDULER_LOAD_MSG_CMD_INDEX_ERR_EID         (SCHEDULER_BASE_EID + 14)
