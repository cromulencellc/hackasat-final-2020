...
/* APBUART0 Setup for Interrupts - Radio */
struct drvmgr_key grlib_drv_res_apbuart0[] =
{
{"mode", DRVMGR_KT_INT, {(unsigned int)1}},
{"syscon", DRVMGR_KT_INT, {(unsigned int)0}},
{"dbgcon", DRVMGR_KT_INT, {(unsigned int)0}},
DRVMGR_KEY_EMPTY
};

/* APBUART1 Setup for Polled - System Console */
...
/* APBUART2 Setup for Interrupts - Eyassat IF */
...
/* APBUART3 Setup for Interrupts - Payload IF */
struct drvmgr_key grlib_drv_res_apbuart3[] =
{
{"mode", DRVMGR_KT_INT, {(unsigned int)1}},
{"syscon", DRVMGR_KT_INT, {(unsigned int)0}},
{"dbgcon", DRVMGR_KT_INT, {(unsigned int)0}},
...
*/
	...
	{DRIVER_AMBAPP_GAISLER_APBUART_ID, 3, &grlib_drv_res_apbuart3[0]},
	DRVMGR_RES_EMPTY
	}
};
