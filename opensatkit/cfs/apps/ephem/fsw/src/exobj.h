...
#define EXOBJ_DEMO_DEBUG_EID    (EXOBJ_BASE_EID + 2)
#define EXOBJ_FILE_OPEN_EID     (EXOBJ_BASE_EID + 3)
#define EXOBJ_INFO_EID          (EXOBJ_BASE_EID + 4)
#define EXOBJ_ERROR_EID         (EXOBJ_BASE_EID + 5)


#define TLE_FILE_PATH           "/cf/tle.txt"
