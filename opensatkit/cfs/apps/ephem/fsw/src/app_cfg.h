/*
** Purpose: Define configurations for the Ephem application.
**
** Notes:
...
#include "cfe.h"
#include "ephem_platform_cfg.h"
#include "osk_app_fw.h"

/******************************************************************************
** Ephem Application Macros
*/

#define  EPHEM_MAJOR_VERSION      0
#define  EPHEM_MINOR_VERSION      9
#define  EPHEM_REVISION           0
#define  EPHEM_MISSION_REV        0
...
#define EPHEM_BASE_EID      (APP_FW_APP_BASE_EID +  0)
