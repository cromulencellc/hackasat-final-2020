...
#define EYASSATOBJ_MAG_CAL_CMD_FC  (CMDMGR_APP_START_FC + 8)
#define EYASSATOBJ_GYRO_CAL_CMD_FC  (CMDMGR_APP_START_FC + 9)
#define EYASSATOBJ_TORQUE_ROD_CMD_FC  (CMDMGR_APP_START_FC + 10)
