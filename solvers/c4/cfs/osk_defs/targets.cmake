...
SET(TGT1_NAME cpu1) 
SET(TGT1_APPLIST osk_app_fw bm cfs_lib cs ds expat_lib fm osk_demo_app hc hs hsim kit_ci kit_sch kit_to lc md mm sc hk tftp i42 f42 isim cf ephem)
SET(TGT1_FILELIST cfe_es_startup.scr kit_to_pkt_tbl.json kit_sch_msg_tbl.json kit_sch_sch_tbl.json osk_demo_tbl.json osk_demo_tbl.scanf osk_demo_tbl.xml f42_ctrl_tbl.json isim_tbl.json tle.txt)
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -m32")

# CPU2 - RTEMS5 - i386
SET(TGT2_NAME cpu2)
SET(TGT2_APPLIST osk_app_fw cfs_lib cs ds expat_lib fm hs kit_ci kit_sch kit_to lc md mm sc hk i42 f42 cf)
#SET(TGT2_APPLIST osk_app_fw bm cfs_lib cs ds expat_lib fm osk_demo_app hc hs hsim kit_ci kit_sch kit_to lc md mm sc hk tftp i42 f42 isim cf)
SET(TGT2_FILELIST cfe_es_startup.scr kit_to_pkt_tbl.json kit_sch_msg_tbl.json kit_sch_sch_tbl.json osk_demo_tbl.json osk_demo_tbl.scanf osk_demo_tbl.xml f42_ctrl_tbl.json)

# CPU3 - RTEMS5 - LEON3 - HW Config
SET(TGT3_NAME cpu3)
#Full Build Set
#SET(TGT3_APPLIST osk_app_fw cfs_lib io_lib cs ds expat_lib fm hs kit_sch lc md mm sc hk eyassat_if cf uart_to_ci pl_if ephem chal4)
#Test Build Set
SET(TGT3_APPLIST osk_app_fw cfs_lib io_lib expat_lib kit_sch eyassat_if uart_to_ci cf pl_if ephem chal4)
SET(TGT3_FILELIST cfe_es_startup.scr uart_to_pkt_tbl.json kit_sch_msg_tbl.json kit_sch_sch_tbl.json es_adcs_tbl.json tle.txt img.png)
# SET(TGT3_EMBED_FILELIST XXX)
# SET(TGT3_TAR_FS TRUE)
